...
class PointCloudFromRgbdToOccupancy(Node):
    def __init__(self):
        ...
        self.declare_parameter('depth_topic', '/camera/realsense/aligned_depth_to_color/image_raw')
        self.declare_parameter('camera_info_topic', '/camera/realsense/aligned_depth_to_color/camera_info')
